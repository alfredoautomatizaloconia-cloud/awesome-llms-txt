...
**File facts:** 8.1 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 4 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://openvpn.net/llms.txt
```
