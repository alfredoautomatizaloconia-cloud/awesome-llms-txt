---
domain: www.concept-designs.com.au
display_name: Concept Designs
category: dev-tools
score: 29
grade: F
last_scored: 2026-05-27
verified_url: https://www.concept-designs.com.au/llms.txt
file_size_bytes: 55983
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 54.7 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 29 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/www.concept-designs.com.au.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/www.concept-designs.com.au)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.concept-designs.com.au/llms.txt
```
