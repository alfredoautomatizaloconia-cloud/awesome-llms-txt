---
domain: docs.ipaper.io
display_name: iPaper Technical Documentation
category: dev-tools
score: 60
grade: C
last_scored: 2026-05-27
verified_url: https://docs.ipaper.io/llms.txt
file_size_bytes: 10344
link_count: 88
value_link_count: 88
section_count: 1
...
**H1:** iPaper Technical Documentation


**File facts:** 10.1 KB · 1 `## sections` · 88 links (88 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.ipaper.io/llms.txt
```
