...
display_name: Manofmany
category: dev-tools
score: 29
grade: F
last_scored: 2026-05-27
verified_url: https://manofmany.com/llms.txt
file_size_bytes: 153782
link_count: 0
value_link_count: 0
section_count: 0
...
![Score 29/100 · Grade F](../../docs/badge/manofmany.com.svg)
...
**File facts:** 150.2 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 4 days (per `Last-Modified`).
...
| Size discipline | 1/6 | _oversized_150kb_ |
...
- Size discipline (1/6): oversized_150kb

## Embed the badge

```markdown
[![llms.txt score 29 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/manofmany.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/manofmany.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://manofmany.com/llms.txt
```
