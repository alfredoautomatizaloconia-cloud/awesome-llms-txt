---
domain: docs.social.plus
display_name: Social Docs
category: dev-tools
score: 59
grade: C
last_scored: 2026-05-27
verified_url: https://docs.social.plus/llms.txt
file_size_bytes: 94293
link_count: 614
value_link_count: 497
section_count: 1
...
**File facts:** 92.1 KB · 1 `## sections` · 614 links (497 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.social.plus/llms.txt
```
