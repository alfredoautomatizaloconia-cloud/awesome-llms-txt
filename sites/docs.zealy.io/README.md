---
domain: docs.zealy.io
display_name: Zealy API
category: dev-tools
score: 58
grade: C
last_scored: 2026-05-27
verified_url: https://docs.zealy.io/llms.txt
file_size_bytes: 3165
link_count: 30
value_link_count: 30
section_count: 1
...
**File facts:** 3.1 KB · 1 `## sections` · 30 links (30 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 58 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.zealy.io.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.zealy.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.zealy.io/llms.txt
```
