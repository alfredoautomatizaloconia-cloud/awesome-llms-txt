---
domain: docs.iproyal.com
display_name: IPRoyal Documentation
category: dev-tools
score: 60
grade: C
last_scored: 2026-05-27
verified_url: https://docs.iproyal.com/llms.txt
file_size_bytes: 17600
link_count: 191
value_link_count: 191
section_count: 2
...
**H1:** IPRoyal Documentation


**File facts:** 17.2 KB · 2 `## sections` · 191 links (191 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 60 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.iproyal.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.iproyal.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.iproyal.com/llms.txt
```
