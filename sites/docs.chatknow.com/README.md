---
domain: docs.chatknow.com
display_name: ChatKnow
category: dev-tools
score: 58
grade: C
last_scored: 2026-05-27
verified_url: https://docs.chatknow.com/llms.txt
file_size_bytes: 26846
link_count: 158
value_link_count: 158
section_count: 1
...
**File facts:** 26.2 KB · 1 `## sections` · 158 links (158 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.chatknow.com/llms.txt
```
