...
verified_url: https://neuronup.com/llms.txt
file_size_bytes: 507633
link_count: 0
value_link_count: 0
section_count: 2
...
**File facts:** 495.7 KB · 2 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
| Size discipline | 1/6 | _oversized_496kb_ |
...
- Size discipline (1/6): oversized_496kb

## Embed the badge

```markdown
[![llms.txt score 34 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/neuronup.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/neuronup.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://neuronup.com/llms.txt
```
