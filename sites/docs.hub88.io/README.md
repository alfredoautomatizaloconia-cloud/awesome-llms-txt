---
domain: docs.hub88.io
display_name: Hub88
category: dev-tools
score: 63
grade: C
last_scored: 2026-05-27
verified_url: https://docs.hub88.io/llms.txt
file_size_bytes: 13849
link_count: 92
value_link_count: 92
section_count: 4
...
**File facts:** 13.5 KB · 4 `## sections` · 92 links (92 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.hub88.io/llms.txt
```
