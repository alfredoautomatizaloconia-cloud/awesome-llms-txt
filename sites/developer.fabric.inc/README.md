---
domain: developer.fabric.inc
display_name: Fabric
category: dev-tools
score: 72
grade: B
last_scored: 2026-05-27
verified_url: https://developer.fabric.inc/llms.txt
file_size_bytes: 17160
link_count: 134
value_link_count: 133
section_count: 2
...
**File facts:** 16.8 KB · 2 `## sections` · 134 links (133 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
| Agent-action declarations | 7/14 | _no_llms_full_link_ |
...
```bash
npx llms-txt-score https://developer.fabric.inc/llms.txt
```
