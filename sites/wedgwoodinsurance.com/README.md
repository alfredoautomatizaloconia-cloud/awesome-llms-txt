---
domain: wedgwoodinsurance.com
display_name: Wedgwoodinsurance
category: dev-tools
score: 34
grade: F
last_scored: 2026-05-27
verified_url: https://wedgwoodinsurance.com/llms.txt
...
![Score 34/100 · Grade F](../../docs/badge/wedgwoodinsurance.com.svg)
...
**File facts:** 3.8 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 6 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 34 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/wedgwoodinsurance.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/wedgwoodinsurance.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://wedgwoodinsurance.com/llms.txt
```
