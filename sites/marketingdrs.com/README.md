---
domain: marketingdrs.com
display_name: Marketingdrs
category: dev-tools
score: 28
grade: F
last_scored: 2026-05-27
verified_url: https://marketingdrs.com/llms.txt
file_size_bytes: 1830
link_count: 0
value_link_count: 0
section_count: 0
freshness_age_days: 337
---
...
**File facts:** 1.8 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 337 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 28 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/marketingdrs.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/marketingdrs.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://marketingdrs.com/llms.txt
```
