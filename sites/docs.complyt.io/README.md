---
domain: docs.complyt.io
display_name: Title
category: dev-tools
score: 66
grade: B
last_scored: 2026-05-27
verified_url: https://docs.complyt.io/llms.txt
file_size_bytes: 7548
link_count: 83
value_link_count: 83
section_count: 3
...
**File facts:** 7.4 KB · 3 `## sections` · 83 links (83 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 66 (B)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.complyt.io.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.complyt.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.complyt.io/llms.txt
```
