...
verified_url: https://www.netlify.com/llms.txt
file_size_bytes: 23496
link_count: 105
value_link_count: 105
section_count: 17
...
![Score 65/100 · Grade B](../../docs/badge/netlify.com.svg)

Category: **infra** · [Live llms.txt](https://www.netlify.com/llms.txt) · Snapshot: [`llms.txt`](./llms.txt) · Machine-readable: [`score.json`](./score.json)

**H1:** LLM documentation for Netlify


**File facts:** 22.9 KB · 17 `## sections` · 105 links (105 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://www.netlify.com/llms.txt
```
