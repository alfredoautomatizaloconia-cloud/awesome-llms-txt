---
domain: iqboatlifts.com
display_name: Iqboatlifts
category: dev-tools
score: 45
grade: D
last_scored: 2026-05-27
verified_url: https://iqboatlifts.com/llms.txt
file_size_bytes: 13021
link_count: 100
value_link_count: 97
section_count: 0
freshness_age_days: 322
---
...
**H1:** https://iqboatlifts.com/ llms.txt


**File facts:** 12.7 KB · 0 `## sections` · 100 links (97 after low-value discount) · Freshness: 322 days (per `Last-Modified`).

## Scorecard

| Criterion | Score | Notes |
|---|---:|---|
| Spec compliance | 10/18 | _h1_is_url, no_blockquote_summary_ |
...
| Freshness | 3/10 | _stale_328_days_ |
| Discoverability | 8/8 | |
...
- Freshness (3/10): stale_328_days
- Auth signposting (0/8): no_auth_keywords, no_auth_section

## Embed the badge

```markdown
[![llms.txt score 45 (D)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/iqboatlifts.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/iqboatlifts.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://iqboatlifts.com/llms.txt
```
