---
domain: docs.whitechain.io
display_name: Whitechain
category: dev-tools
score: 55
grade: C
last_scored: 2026-05-27
verified_url: https://docs.whitechain.io/llms.txt
file_size_bytes: 2613
link_count: 20
value_link_count: 20
section_count: 1
...
**File facts:** 2.6 KB · 1 `## sections` · 20 links (20 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 55 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.whitechain.io.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.whitechain.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.whitechain.io/llms.txt
```
