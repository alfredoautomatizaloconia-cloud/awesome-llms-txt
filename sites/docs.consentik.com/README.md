---
domain: docs.consentik.com
display_name: Consentik GDPR Cookie Banner
category: dev-tools
score: 58
grade: C
last_scored: 2026-05-27
verified_url: https://docs.consentik.com/llms.txt
file_size_bytes: 11083
link_count: 75
value_link_count: 75
section_count: 3
...
**H1:** Consentik GDPR Cookie Banner


**File facts:** 10.8 KB · 3 `## sections` · 75 links (75 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 58 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.consentik.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.consentik.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.consentik.com/llms.txt
```
