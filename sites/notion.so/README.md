...
verified_url: https://www.notion.so/llms.txt
file_size_bytes: 6918
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 6.8 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 29 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/notion.so.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/notion.so)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.notion.so/llms.txt
```
