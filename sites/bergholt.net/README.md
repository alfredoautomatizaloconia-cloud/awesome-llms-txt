---
domain: bergholt.net
display_name: Kasper Bergholt
category: dev-tools
score: 59
grade: C
last_scored: 2026-05-27
verified_url: https://bergholt.net/llms.txt
file_size_bytes: 8129
link_count: 33
value_link_count: 32
section_count: 4
...
**File facts:** 7.9 KB · 4 `## sections` · 33 links (32 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 59 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/bergholt.net.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/bergholt.net)
```

## Reproduce this score

```bash
npx llms-txt-score https://bergholt.net/llms.txt
```
