---
domain: docs.phare.io
display_name: Phare Documentation
category: dev-tools
score: 73
grade: B
last_scored: 2026-05-27
verified_url: https://docs.phare.io/llms.txt
file_size_bytes: 9828
link_count: 71
value_link_count: 70
section_count: 3
...
**H1:** Phare Documentation


**File facts:** 9.6 KB · 3 `## sections` · 71 links (70 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://docs.phare.io/llms.txt
```
