---
domain: docs.imagin.studio
display_name: Customer Success Center
category: dev-tools
score: 57
grade: C
last_scored: 2026-05-27
verified_url: https://docs.imagin.studio/llms.txt
file_size_bytes: 5361
link_count: 44
value_link_count: 44
section_count: 1
...
**H1:** Customer Success Center


**File facts:** 5.2 KB · 1 `## sections` · 44 links (44 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.imagin.studio/llms.txt
```
