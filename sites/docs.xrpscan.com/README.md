---
domain: docs.xrpscan.com
display_name: XRPSCAN
category: dev-tools
score: 57
grade: C
last_scored: 2026-05-27
verified_url: https://docs.xrpscan.com/llms.txt
file_size_bytes: 6763
link_count: 71
value_link_count: 71
section_count: 1
...
**File facts:** 6.6 KB · 1 `## sections` · 71 links (71 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 57 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.xrpscan.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.xrpscan.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.xrpscan.com/llms.txt
```
