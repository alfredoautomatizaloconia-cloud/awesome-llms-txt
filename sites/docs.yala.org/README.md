---
domain: docs.yala.org
display_name: Yala
category: dev-tools
score: 55
grade: C
last_scored: 2026-05-27
verified_url: https://docs.yala.org/llms.txt
file_size_bytes: 3324
link_count: 26
value_link_count: 26
section_count: 1
...
**File facts:** 3.2 KB · 1 `## sections` · 26 links (26 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.yala.org/llms.txt
```
