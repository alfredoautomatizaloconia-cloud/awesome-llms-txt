---
domain: docs.kiloex.io
display_name: KiloEx
category: dev-tools
score: 55
grade: C
last_scored: 2026-05-27
verified_url: https://docs.kiloex.io/kiloex/llms.txt
file_size_bytes: 7187
link_count: 54
value_link_count: 54
section_count: 1
...
**File facts:** 7.0 KB · 1 `## sections` · 54 links (54 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.kiloex.io/kiloex/llms.txt
```
