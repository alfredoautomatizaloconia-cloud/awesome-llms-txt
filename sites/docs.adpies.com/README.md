---
domain: docs.adpies.com
display_name: AdPie
category: dev-tools
score: 55
grade: C
last_scored: 2026-05-27
verified_url: https://platform-business.gitbook.io/adpie/llms.txt
file_size_bytes: 6776
link_count: 52
value_link_count: 52
section_count: 1
...
**File facts:** 6.6 KB · 1 `## sections` · 52 links (52 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 55 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.adpies.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.adpies.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://platform-business.gitbook.io/adpie/llms.txt
```
