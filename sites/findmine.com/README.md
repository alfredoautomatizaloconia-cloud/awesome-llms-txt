---
domain: findmine.com
display_name: Findmine
category: dev-tools
score: 28
grade: F
last_scored: 2026-05-27
verified_url: https://www.findmine.com/llms.txt
file_size_bytes: 16129
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 15.8 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 28 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/findmine.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/findmine.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.findmine.com/llms.txt
```
