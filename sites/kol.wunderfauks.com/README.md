---
domain: kol.wunderfauks.com
display_name: Kol
category: dev-tools
score: 41
grade: D
last_scored: 2026-05-27
verified_url: https://kol.wunderfauks.com/llms.txt
file_size_bytes: 1120
link_count: 9
value_link_count: 9
section_count: 0
freshness_age_days: 343
---
...
**H1:** https://kol.wunderfauks.com/ llms.txt


**File facts:** 1.1 KB · 0 `## sections` · 9 links (9 after low-value discount) · Freshness: 343 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 41 (D)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/kol.wunderfauks.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/kol.wunderfauks.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://kol.wunderfauks.com/llms.txt
```
