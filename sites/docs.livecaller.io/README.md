---
domain: docs.livecaller.io
display_name: Livecaller Guides
category: dev-tools
score: 58
grade: C
last_scored: 2026-05-27
verified_url: https://docs.livecaller.io/livecaller/llms.txt
file_size_bytes: 7897
link_count: 68
value_link_count: 68
section_count: 1
...
**H1:** Livecaller Guides


**File facts:** 7.7 KB · 1 `## sections` · 68 links (68 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 58 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.livecaller.io.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.livecaller.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.livecaller.io/livecaller/llms.txt
```
