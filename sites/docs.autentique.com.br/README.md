---
domain: docs.autentique.com.br
display_name: Documentation
category: dev-tools
score: 53
grade: C
last_scored: 2026-05-27
verified_url: https://docs.autentique.com.br/api/llms.txt
file_size_bytes: 5316
link_count: 28
value_link_count: 28
section_count: 1
...
**File facts:** 5.2 KB · 1 `## sections` · 28 links (28 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 53 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.autentique.com.br.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.autentique.com.br)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.autentique.com.br/api/llms.txt
```
