---
domain: docs.beacon.li
display_name: Beacon Docs
category: dev-tools
score: 56
grade: C
last_scored: 2026-05-27
verified_url: https://docs.beacon.li/llms.txt
file_size_bytes: 2557
link_count: 21
value_link_count: 21
section_count: 1
...
**File facts:** 2.5 KB · 1 `## sections` · 21 links (21 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 56 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.beacon.li.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.beacon.li)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.beacon.li/llms.txt
```
