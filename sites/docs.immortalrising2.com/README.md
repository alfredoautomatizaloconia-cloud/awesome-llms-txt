---
domain: docs.immortalrising2.com
display_name: Immortal Rising 2
category: dev-tools
score: 55
grade: C
last_scored: 2026-05-27
verified_url: https://docs.immortalrising2.com/llms.txt
file_size_bytes: 5053
link_count: 35
value_link_count: 27
section_count: 1
...
**H1:** Immortal Rising 2


**File facts:** 4.9 KB · 1 `## sections` · 35 links (27 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 55 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.immortalrising2.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.immortalrising2.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.immortalrising2.com/llms.txt
```
