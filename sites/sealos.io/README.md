...
verified_url: https://sealos.io/llms.txt
file_size_bytes: 441728
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 431.4 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
| Size discipline | 1/6 | _oversized_431kb_ |
...
- Size discipline (1/6): oversized_431kb
...
```bash
npx llms-txt-score https://sealos.io/llms.txt
```
