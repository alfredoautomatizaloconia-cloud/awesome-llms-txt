---
domain: docs.couchdrop.io
display_name: Couchdrop Knowledge Base
category: dev-tools
score: 59
grade: C
last_scored: 2026-05-27
verified_url: https://docs.couchdrop.io/llms.txt
file_size_bytes: 17734
link_count: 110
...
**H1:** Couchdrop Knowledge Base


**File facts:** 17.3 KB · 1 `## sections` · 110 links (110 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 59 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.couchdrop.io.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.couchdrop.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.couchdrop.io/llms.txt
```
