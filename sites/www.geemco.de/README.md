...
**H1:** GeeMco – Götz Müller Consulting


**File facts:** 10.6 KB · 5 `## sections` · 49 links (31 after low-value discount) · Freshness: 6 days (per `Last-Modified`).

## Scorecard

| Criterion | Score | Notes |
|---|---:|---|
| Spec compliance | 14/18 | _multi_h1_8, no_blockquote_summary_ |
...
```bash
npx llms-txt-score https://www.geemco.de/llms.txt
```
