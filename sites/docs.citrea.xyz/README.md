---
domain: docs.citrea.xyz
display_name: Citrea
category: dev-tools
score: 57
grade: C
last_scored: 2026-05-27
verified_url: https://docs.citrea.xyz/llms.txt
file_size_bytes: 8080
link_count: 78
value_link_count: 74
section_count: 1
...
**File facts:** 7.9 KB · 1 `## sections` · 78 links (74 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 57 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.citrea.xyz.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.citrea.xyz)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.citrea.xyz/llms.txt
```
