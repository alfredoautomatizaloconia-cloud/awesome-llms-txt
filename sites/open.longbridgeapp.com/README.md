---
domain: open.longbridgeapp.com
display_name: LongPort OpenAPI Documentation
category: dev-tools
score: 70
grade: B
last_scored: 2026-05-27
verified_url: https://open.longportapp.com/llms.txt
file_size_bytes: 10856
link_count: 76
value_link_count: 76
section_count: 22
freshness_age_days: 165
---

# LongPort OpenAPI Documentation

![Score 70/100 · Grade B](../../docs/badge/open.longbridgeapp.com.svg)
...
**H1:** LongPort OpenAPI Documentation


**File facts:** 10.6 KB · 22 `## sections` · 76 links (76 after low-value discount) · Freshness: 165 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://open.longportapp.com/llms.txt
```
