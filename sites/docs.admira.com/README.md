---
domain: docs.admira.com
display_name: Admira Docs
category: dev-tools
score: 60
grade: C
last_scored: 2026-05-27
verified_url: https://docs.admira.com/llms.txt
file_size_bytes: 17878
link_count: 188
value_link_count: 188
section_count: 2
...
**File facts:** 17.5 KB · 2 `## sections` · 188 links (188 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 60 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.admira.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.admira.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.admira.com/llms.txt
```
