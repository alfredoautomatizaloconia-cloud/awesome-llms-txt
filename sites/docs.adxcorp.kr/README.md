---
domain: docs.adxcorp.kr
display_name: AD(X)
category: dev-tools
score: 55
grade: C
last_scored: 2026-05-27
verified_url: https://platform-business.gitbook.io/adx/llms.txt
file_size_bytes: 6459
link_count: 56
value_link_count: 56
section_count: 1
...
**File facts:** 6.3 KB · 1 `## sections` · 56 links (56 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 55 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.adxcorp.kr.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.adxcorp.kr)
```

## Reproduce this score

```bash
npx llms-txt-score https://platform-business.gitbook.io/adx/llms.txt
```
