---
domain: www.gaslightingcheck.com
display_name: Gaslighting Check
category: dev-tools
score: 60
grade: C
last_scored: 2026-05-27
verified_url: https://www.gaslightingcheck.com/llms.txt
file_size_bytes: 1598
link_count: 12
value_link_count: 9
section_count: 4
...
**H1:** Gaslighting Check

> Gaslighting Check is an AI-powered tool that analyzes text, audio, and conversations to detect manipulation tactics like gaslighting, blame shifting, and emotional abuse. Features AI coach for personalized guidance and building a supportive community for abuse survivors.

**File facts:** 1.6 KB · 4 `## sections` · 12 links (9 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://www.gaslightingcheck.com/llms.txt
```
