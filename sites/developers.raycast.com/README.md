...
display_name: Raycast API
category: dev-tools
score: 60
grade: C
last_scored: 2026-05-27
verified_url: https://developers.raycast.com/llms.txt
file_size_bytes: 11365
link_count: 107
value_link_count: 107
section_count: 1
...
**File facts:** 11.1 KB · 1 `## sections` · 107 links (107 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://developers.raycast.com/llms.txt
```
