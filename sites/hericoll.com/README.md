---
domain: hericoll.com
display_name: Hericoll
category: dev-tools
score: 45
grade: D
last_scored: 2026-05-27
verified_url: https://hericoll.com/llms.txt
...
**H1:** https://hericoll.com/ llms.txt


**File facts:** 13.9 KB · 0 `## sections` · 98 links (96 after low-value discount) · Freshness: 343 days (per `Last-Modified`).
...
| Freshness | 3/10 | _stale_349_days_ |
| Discoverability | 8/8 | |
...
- Freshness (3/10): stale_349_days
- Auth signposting (0/8): no_auth_keywords, no_auth_section

## Embed the badge

```markdown
[![llms.txt score 45 (D)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/hericoll.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/hericoll.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://hericoll.com/llms.txt
```
