---
domain: www.assuranceendirect.com
display_name: Assuranceendirect
category: dev-tools
score: 26
grade: F
last_scored: 2026-05-27
verified_url: https://www.assuranceendirect.com/llms.txt
file_size_bytes: 180112
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 175.9 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
| Size discipline | 1/6 | _oversized_176kb_ |
...
- Size discipline (1/6): oversized_176kb

## Embed the badge

```markdown
[![llms.txt score 26 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/www.assuranceendirect.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/www.assuranceendirect.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.assuranceendirect.com/llms.txt
```
