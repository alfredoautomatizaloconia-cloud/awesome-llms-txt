---
domain: pixonstudio.com
display_name: Detailed Content
category: dev-tools
score: 39
grade: D
last_scored: 2026-05-27
verified_url: https://pixonstudio.com/llms.txt
file_size_bytes: 14776
link_count: 0
value_link_count: 0
section_count: 2
freshness_age_days: 48
---
...
**File facts:** 14.4 KB · 2 `## sections` · 0 links (0 after low-value discount) · Freshness: 48 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 39 (D)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/pixonstudio.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/pixonstudio.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://pixonstudio.com/llms.txt
```
