...
verified_url: https://www.lazada.com.my/llms.txt
file_size_bytes: 2669
link_count: 0
value_link_count: 0
section_count: 4
...
**H1:** Lazada Malaysia (lazada.com.my)


**File facts:** 2.6 KB · 4 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 43 (D)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/www.lazada.com.my.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/www.lazada.com.my)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.lazada.com.my/llms.txt
```
