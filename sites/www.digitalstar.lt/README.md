---
domain: www.digitalstar.lt
display_name: Digitalstar
category: dev-tools
score: 22
grade: F
last_scored: 2026-05-27
verified_url: https://www.digitalstar.lt/llms.txt
file_size_bytes: 120
link_count: 0
value_link_count: 0
section_count: 0
freshness_age_days: 304
---
...
**File facts:** 0.1 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 304 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://www.digitalstar.lt/llms.txt
```
