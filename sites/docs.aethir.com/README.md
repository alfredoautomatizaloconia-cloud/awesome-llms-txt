---
domain: docs.aethir.com
display_name: Aethir
category: dev-tools
score: 58
grade: C
last_scored: 2026-05-27
verified_url: https://docs.aethir.com/llms.txt
file_size_bytes: 17586
link_count: 155
value_link_count: 155
section_count: 1
...
**File facts:** 17.2 KB · 1 `## sections` · 155 links (155 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 58 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.aethir.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.aethir.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.aethir.com/llms.txt
```
