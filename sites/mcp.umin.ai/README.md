...
file_size_bytes: 4373
link_count: 26
value_link_count: 26
section_count: 8
freshness_age_days: 176
---
...
**H1:** mcp.umin.ai | uminai MCP (Model Context Protocol) Servers Directory

> #1 Largest curated collection of MCP Servers, including Awesome MCP Servers and tutorial for LLM integration. Extend your MCP servers to enhance your AI capabilities through our search and discovery.

**File facts:** 4.3 KB · 8 `## sections` · 26 links (26 after low-value discount) · Freshness: 176 days (per `Last-Modified`).

## Scorecard

| Criterion | Score | Notes |
|---|---:|---|
| Spec compliance | 13/18 | _multi_h1_2, sections_without_link_lists, malformed_link_items_ |
...
```bash
npx llms-txt-score https://mcp.umin.ai/llms.txt
```
