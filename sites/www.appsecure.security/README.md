---
domain: www.appsecure.security
display_name: Appsecure
category: dev-tools
score: 36
grade: D
last_scored: 2026-05-27
verified_url: https://www.appsecure.security/llms.txt
file_size_bytes: 5533
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 5.4 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://www.appsecure.security/llms.txt
```
