---
domain: docs.whereby.com
display_name: Whereby
category: dev-tools
score: 59
grade: C
last_scored: 2026-05-27
verified_url: https://docs.whereby.com/llms.txt
file_size_bytes: 23202
link_count: 125
value_link_count: 125
section_count: 1
...
**File facts:** 22.7 KB · 1 `## sections` · 125 links (125 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 59 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.whereby.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.whereby.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.whereby.com/llms.txt
```
