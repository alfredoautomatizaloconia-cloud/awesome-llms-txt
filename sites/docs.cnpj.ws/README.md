...
verified_url: https://docs.cnpj.ws/llms.txt
file_size_bytes: 4970
link_count: 38
value_link_count: 28
section_count: 1
...
**File facts:** 4.9 KB · 1 `## sections` · 38 links (28 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 55 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.cnpj.ws.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.cnpj.ws)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.cnpj.ws/llms.txt
```
