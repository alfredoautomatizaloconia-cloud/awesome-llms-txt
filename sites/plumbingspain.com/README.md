---
domain: plumbingspain.com
display_name: Detailed Content
category: dev-tools
score: 39
grade: D
last_scored: 2026-05-27
verified_url: https://plumbingspain.com/llms.txt
file_size_bytes: 3194
link_count: 0
value_link_count: 0
section_count: 2
freshness_age_days: 119
---
...
**File facts:** 3.1 KB · 2 `## sections` · 0 links (0 after low-value discount) · Freshness: 119 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 39 (D)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/plumbingspain.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/plumbingspain.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://plumbingspain.com/llms.txt
```
