---
domain: docs.bucket.co
display_name: Reflag docs
category: dev-tools
score: 56
grade: C
last_scored: 2026-05-27
verified_url: https://docs.reflag.com/llms.txt
file_size_bytes: 9376
link_count: 76
value_link_count: 76
section_count: 1
...
**File facts:** 9.2 KB · 1 `## sections` · 76 links (76 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.reflag.com/llms.txt
```
