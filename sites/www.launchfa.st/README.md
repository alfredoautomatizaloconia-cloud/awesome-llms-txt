---
domain: www.launchfa.st
display_name: LaunchFast
category: dev-tools
score: 50
grade: C
last_scored: 2026-05-27
verified_url: https://www.launchfa.st/llms.txt
file_size_bytes: 485
link_count: 2
value_link_count: 2
section_count: 2
...
**File facts:** 0.5 KB · 2 `## sections` · 2 links (2 after low-value discount) · Freshness: unknown (no `Last-Modified` header).

## Scorecard

| Criterion | Score | Notes |
|---|---:|---|
| Spec compliance | 13/18 | _no_blockquote_summary, sections_without_link_lists, malformed_link_items_ |
...
```bash
npx llms-txt-score https://www.launchfa.st/llms.txt
```
