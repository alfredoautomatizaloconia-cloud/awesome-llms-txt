---
domain: docs.dataimpulse.com
display_name: DataImpulse
category: dev-tools
score: 58
grade: C
last_scored: 2026-05-27
verified_url: https://docs.dataimpulse.com/llms.txt
file_size_bytes: 9009
link_count: 41
value_link_count: 41
section_count: 1
...
**File facts:** 8.8 KB · 1 `## sections` · 41 links (41 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 58 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.dataimpulse.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.dataimpulse.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.dataimpulse.com/llms.txt
```
