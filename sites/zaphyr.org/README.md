---
domain: zaphyr.org
display_name: ZAPHYR PHP Framework
category: dev-tools
score: 41
grade: D
last_scored: 2026-05-27
verified_url: https://zaphyr.org/llms.txt
file_size_bytes: 3608
link_count: 0
value_link_count: 0
section_count: 5
freshness_age_days: 438
---
...
**H1:** ZAPHYR PHP Framework


**File facts:** 3.5 KB · 5 `## sections` · 0 links (0 after low-value discount) · Freshness: 438 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 41 (D)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/zaphyr.org.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/zaphyr.org)
```

## Reproduce this score

```bash
npx llms-txt-score https://zaphyr.org/llms.txt
```
