---
domain: data-surfer.com
display_name: Data Surfer
category: dev-tools
score: 40
grade: D
last_scored: 2026-05-27
verified_url: https://data-surfer.com/llms.txt
file_size_bytes: 899
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 0.9 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 10 days (per `Last-Modified`).

## Scorecard

| Criterion | Score | Notes |
|---|---:|---|
| Spec compliance | 6/18 | _no_blockquote_summary, no_structure, malformed_link_items_ |
...
- Spec compliance (6/18): no_blockquote_summary, no_structure, malformed_link_items
...
```markdown
[![llms.txt score 40 (D)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/data-surfer.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/data-surfer.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://data-surfer.com/llms.txt
```
