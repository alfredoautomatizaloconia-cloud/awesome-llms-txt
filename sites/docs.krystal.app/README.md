---
domain: docs.krystal.app
display_name: Krystal Docs
category: dev-tools
score: 57
grade: C
last_scored: 2026-05-27
verified_url: https://docs.krystal.app/llms.txt
file_size_bytes: 7242
link_count: 67
value_link_count: 67
section_count: 1
...
**File facts:** 7.1 KB · 1 `## sections` · 67 links (67 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 57 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.krystal.app.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.krystal.app)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.krystal.app/llms.txt
```
