...
verified_url: https://www.twilio.com:443/llms.txt
file_size_bytes: 2239756
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 2187.3 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 15 days (per `Last-Modified`).
...
| Size discipline | 0/6 | _oversized_2187kb_ |
...
- Size discipline (0/6): oversized_2187kb
...
```bash
npx llms-txt-score https://www.twilio.com:443/llms.txt
```
