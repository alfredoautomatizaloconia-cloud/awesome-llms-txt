...
display_name: Cohere Docs
category: ai-platform
score: 31
grade: F
last_scored: 2026-05-27
verified_url: https://docs.cohere.com/llms.txt
file_size_bytes: 697
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 0.7 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.cohere.com/llms.txt
```
