---
domain: www.taxbandits.com
display_name: Taxbandits
category: dev-tools
score: 27
grade: F
last_scored: 2026-05-27
verified_url: https://www.taxbandits.com/llms.txt
file_size_bytes: 161250
link_count: 0
value_link_count: 0
section_count: 0
freshness_age_days: 83
---
...
**File facts:** 157.5 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 83 days (per `Last-Modified`).
...
| Size discipline | 1/6 | _oversized_157kb_ |
...
- Size discipline (1/6): oversized_157kb

## Embed the badge

```markdown
[![llms.txt score 27 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/www.taxbandits.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/www.taxbandits.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.taxbandits.com/llms.txt
```
