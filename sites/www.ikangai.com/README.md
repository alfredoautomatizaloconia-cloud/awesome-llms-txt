---
domain: www.ikangai.com
display_name: Ikangai
category: dev-tools
score: 34
grade: F
last_scored: 2026-05-27
verified_url: https://www.ikangai.com/llms.txt
file_size_bytes: 2625
link_count: 0
value_link_count: 0
section_count: 0
...
![Score 34/100 · Grade F](../../docs/badge/www.ikangai.com.svg)
...
**File facts:** 2.6 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 5 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 34 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/www.ikangai.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/www.ikangai.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.ikangai.com/llms.txt
```
