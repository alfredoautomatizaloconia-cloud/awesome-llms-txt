---
domain: docs.intelligems.io
display_name: Intelligems Docs
category: dev-tools
score: 61
grade: C
last_scored: 2026-05-27
verified_url: https://docs.intelligems.io/llms.txt
file_size_bytes: 49101
link_count: 288
value_link_count: 288
section_count: 1
...
**File facts:** 48.0 KB · 1 `## sections` · 288 links (288 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.intelligems.io/llms.txt
```
