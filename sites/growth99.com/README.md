---
domain: growth99.com
display_name: Growth99
category: dev-tools
score: 28
grade: F
last_scored: 2026-05-27
verified_url: https://growth99.com/llms.txt
file_size_bytes: 5522
link_count: 0
value_link_count: 0
section_count: 0
freshness_age_days: 347
---
...
**File facts:** 5.4 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 347 days (per `Last-Modified`).
...
| Freshness | 3/10 | _stale_352_days_ |
| Discoverability | 8/8 | |
...
- Freshness (3/10): stale_352_days
- Auth signposting (0/8): no_auth_keywords, no_auth_section

## Embed the badge

```markdown
[![llms.txt score 28 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/growth99.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/growth99.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://growth99.com/llms.txt
```
