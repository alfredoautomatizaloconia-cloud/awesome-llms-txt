...
verified_url: https://www.amema.at/llms.txt
file_size_bytes: 14910
link_count: 0
value_link_count: 0
section_count: 0
freshness_age_days: 274
---
...
**File facts:** 14.6 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 274 days (per `Last-Modified`).
...
| Freshness | 3/10 | _stale_279_days_ |
| Discoverability | 8/8 | |
...
- Freshness (3/10): stale_279_days
- Auth signposting (0/8): no_auth_keywords, no_auth_section

## Embed the badge

```markdown
[![llms.txt score 27 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/www.amema.at.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/www.amema.at)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.amema.at/llms.txt
```
