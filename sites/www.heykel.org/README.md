---
domain: www.heykel.org
display_name: Heykel
category: dev-tools
score: 48
grade: D
last_scored: 2026-05-27
verified_url: https://www.heykel.org/llms.txt
file_size_bytes: 5355
link_count: 0
value_link_count: 0
section_count: 9
...
**H1:** Heykel.org - Heykel İmalatı Üretimi ve Siparişi


**File facts:** 5.2 KB · 9 `## sections` · 0 links (0 after low-value discount) · Freshness: 24 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://www.heykel.org/llms.txt
```
