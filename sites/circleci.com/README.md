...
verified_url: https://circleci.com/llms.txt
file_size_bytes: 5938
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 5.8 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://circleci.com/llms.txt
```
