---
domain: docs.sourceforge.net
display_name: SourceForge
category: dev-tools
score: 65
grade: B
last_scored: 2026-05-27
verified_url: https://docs.sourceforge.net/llms.txt
file_size_bytes: 4846
link_count: 52
value_link_count: 51
section_count: 1
...
**File facts:** 4.7 KB · 1 `## sections` · 52 links (51 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 65 (B)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.sourceforge.net.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.sourceforge.net)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.sourceforge.net/llms.txt
```
