...
verified_url: https://docs.turso.tech/llms.txt
file_size_bytes: 31705
link_count: 272
value_link_count: 272
section_count: 3
...
**File facts:** 31.0 KB · 3 `## sections` · 272 links (272 after low-value discount) · Freshness: 0 days (per `Last-Modified`).
...
```bash
npx llms-txt-score https://docs.turso.tech/llms.txt
```
