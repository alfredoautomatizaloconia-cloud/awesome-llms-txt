---
domain: www.eastagile.com
display_name: Eastagile
category: dev-tools
score: 32
grade: F
last_scored: 2026-05-27
verified_url: https://www.eastagile.com/llms.txt
file_size_bytes: 3703
link_count: 0
value_link_count: 0
section_count: 0
freshness_age_days: 42
---
...
**File facts:** 3.6 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 42 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 32 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/www.eastagile.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/www.eastagile.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.eastagile.com/llms.txt
```
