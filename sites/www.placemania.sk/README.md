---
domain: www.placemania.sk
display_name: Placemania
category: dev-tools
score: 31
grade: F
last_scored: 2026-05-27
verified_url: https://www.placemania.sk/llms.txt
file_size_bytes: 5204
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 5.1 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://www.placemania.sk/llms.txt
```
