---
domain: docs.carbon.network
display_name: Demex Docs
category: dev-tools
score: 55
grade: C
last_scored: 2026-05-27
verified_url: https://guide.dem.exchange:443/llms.txt
file_size_bytes: 34430
link_count: 259
value_link_count: 235
section_count: 1
...
**File facts:** 33.6 KB · 1 `## sections` · 259 links (235 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://guide.dem.exchange:443/llms.txt
```
