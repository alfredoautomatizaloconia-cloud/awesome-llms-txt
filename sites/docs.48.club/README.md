---
domain: docs.48.club
display_name: 48 Club
category: dev-tools
score: 57
grade: C
last_scored: 2026-05-27
verified_url: https://docs.48.club/llms.txt
file_size_bytes: 4700
link_count: 47
value_link_count: 47
section_count: 1
...
**File facts:** 4.6 KB · 1 `## sections` · 47 links (47 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 57 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.48.club.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.48.club)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.48.club/llms.txt
```
