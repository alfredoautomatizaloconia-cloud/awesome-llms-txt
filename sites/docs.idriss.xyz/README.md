---
domain: docs.idriss.xyz
display_name: Docs
category: dev-tools
score: 54
grade: C
last_scored: 2026-05-27
verified_url: https://docs.idriss.xyz/llms.txt
file_size_bytes: 1442
link_count: 10
value_link_count: 10
section_count: 1
...
**File facts:** 1.4 KB · 1 `## sections` · 10 links (10 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
| Coverage | 5/20 | _thin_sectioning, missing_canonical_sections_ |
...
- Coverage (5/20): thin_sectioning, missing_canonical_sections
...
```bash
npx llms-txt-score https://docs.idriss.xyz/llms.txt
```
