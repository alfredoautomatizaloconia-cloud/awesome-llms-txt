...
verified_url: https://sellm.io/llms.txt
file_size_bytes: 922
link_count: 0
value_link_count: 0
section_count: 0
...
**File facts:** 0.9 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 30 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/sellm.io.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/sellm.io)
```

## Reproduce this score

```bash
npx llms-txt-score https://sellm.io/llms.txt
```
