---
domain: docs.iagentpro.com
display_name: iAgent whitepaper
category: dev-tools
score: 55
grade: C
last_scored: 2026-05-27
verified_url: https://docs.iagentpro.com/llms.txt
file_size_bytes: 3974
link_count: 38
value_link_count: 38
section_count: 1
...
**H1:** iAgent whitepaper


**File facts:** 3.9 KB · 1 `## sections` · 38 links (38 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 55 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.iagentpro.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.iagentpro.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.iagentpro.com/llms.txt
```
