---
domain: docs.kintsu.xyz
display_name: Kintsu - Liquid Staking on Monad
category: dev-tools
score: 55
grade: C
last_scored: 2026-05-27
verified_url: https://docs.kintsu.xyz/llms.txt
file_size_bytes: 5538
link_count: 36
value_link_count: 33
section_count: 1
...
**H1:** Kintsu - Liquid Staking on Monad


**File facts:** 5.4 KB · 1 `## sections` · 36 links (33 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 55 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.kintsu.xyz.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.kintsu.xyz)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.kintsu.xyz/llms.txt
```
