---
domain: www.yellowlime.nl
display_name: Yellowlime
category: dev-tools
score: 29
grade: F
last_scored: 2026-05-27
verified_url: https://www.yellowlime.nl/llms.txt
file_size_bytes: 1511
link_count: 0
value_link_count: 0
section_count: 0
freshness_age_days: 320
---
...
**File facts:** 1.5 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 320 days (per `Last-Modified`).
...
| Freshness | 3/10 | _stale_326_days_ |
| Discoverability | 8/8 | |
...
- Freshness (3/10): stale_326_days
- Auth signposting (0/8): no_auth_keywords, no_auth_section

## Embed the badge

```markdown
[![llms.txt score 29 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/www.yellowlime.nl.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/www.yellowlime.nl)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.yellowlime.nl/llms.txt
```
