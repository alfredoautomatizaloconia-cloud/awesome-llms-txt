---
domain: www.positrixpower.com
display_name: Positrixpower
category: dev-tools
score: 26
grade: F
last_scored: 2026-05-27
verified_url: https://www.positrixpower.com/llms.txt
file_size_bytes: 5181
link_count: 0
value_link_count: 0
section_count: 0
freshness_age_days: 388
---
...
**File facts:** 5.1 KB · 0 `## sections` · 0 links (0 after low-value discount) · Freshness: 388 days (per `Last-Modified`).
...
```markdown
[![llms.txt score 26 (F)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/www.positrixpower.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/www.positrixpower.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://www.positrixpower.com/llms.txt
```
