---
domain: docs.bsquared.network
display_name: B² Network
category: dev-tools
score: 55
grade: C
last_scored: 2026-05-27
verified_url: https://docs.bsquared.network/llms.txt
file_size_bytes: 4226
link_count: 38
value_link_count: 38
section_count: 1
...
**File facts:** 4.1 KB · 1 `## sections` · 38 links (38 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```markdown
[![llms.txt score 55 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/docs.bsquared.network.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/docs.bsquared.network)
```

## Reproduce this score

```bash
npx llms-txt-score https://docs.bsquared.network/llms.txt
```
