---
domain: docs.zipchat.ai
display_name: Zipchat
category: dev-tools
score: 56
grade: C
last_scored: 2026-05-27
verified_url: https://docs.zipchat.ai/llms.txt
file_size_bytes: 9162
link_count: 69
value_link_count: 69
section_count: 1
...
![Score 56/100 · Grade C](../../docs/badge/docs.zipchat.ai.svg)

Category: **dev-tools** · [Live llms.txt](https://docs.zipchat.ai/llms.txt) · Snapshot: [`llms.txt`](./llms.txt) · Machine-readable: [`score.json`](./score.json)

**H1:** Zipchat


**File facts:** 8.9 KB · 1 `## sections` · 69 links (69 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
```bash
npx llms-txt-score https://docs.zipchat.ai/llms.txt
```
