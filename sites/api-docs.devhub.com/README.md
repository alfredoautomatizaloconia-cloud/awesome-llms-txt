---
domain: api-docs.devhub.com
display_name: DevHub API Documentation
category: dev-tools
score: 61
grade: C
last_scored: 2026-05-27
verified_url: https://api-docs.devhub.com/llms.txt
file_size_bytes: 5160
link_count: 42
value_link_count: 42
section_count: 1
...
**H1:** DevHub API Documentation


**File facts:** 5.0 KB · 1 `## sections` · 42 links (42 after low-value discount) · Freshness: unknown (no `Last-Modified` header).
...
| Coverage | 10/20 | _thin_sectioning_ |
...
```markdown
[![llms.txt score 61 (C)](https://raw.githubusercontent.com/zriyansh/awesome-llms-txt/main/docs/badge/api-docs.devhub.com.svg)](https://github.com/zriyansh/awesome-llms-txt/tree/main/sites/api-docs.devhub.com)
```

## Reproduce this score

```bash
npx llms-txt-score https://api-docs.devhub.com/llms.txt
```
